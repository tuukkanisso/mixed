...
class Intro extends Component{
	...
	myHover(){
		...
		a.addEventListener('click',(e)=>{
			var id;
			for(var i in e.path){
				if(e.path[i].querySelector('.introText')){
					id=e.path[i].querySelector('.introText').id;
					break
				}
			}
	...
	instagramPosts(){
		...
		const token = '4332207348.ea97ad5.d1a3d54260ad412fb8c9b948667c7e15';
	...
	render(){
		...
		<div id="introduction" className="col-12 my-2">
			...
			<div className="display-linebreak row" style={{height:'100%'}}>
				<div className="col-8 mb-0">
					<div className="row m-auto" style={{maxHeight:height-100, height:'100%'}}>
						<div className="col-12 pl-5 pointer introText" id="myIntro">
							<div className="row bg-grey rounded">
								<div id="myCareer" className="introPic"> 
									...
									<h2 className="imgClick" style={{position:'absolute', zIndex:'500', top:'50%',left:'30%', transform:'translate(-50%,-50%)'}}>Developer</h2>
								</div>
						...
						<div className="col-12 pl-5 mt-2 pointer introText" id="myIntroAthletics">
							<div className="row bg-grey rounded">
								<div id="myAthletics" className="introPic">
									...
									<h2 className="imgClick" dataTitle="Athlete" style={{position:'absolute', zIndex:'500', top:'50%',left:'40%', transform:'translate(-50%,-50%)'}}>Athlete</h2>
								</div>
								<div className="col-12">
									<p>
										Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean efficitur lobortis condimentum. Phasellus finibus sodales tellus nec finibus. Etiam quis felis arcu. Cras elementum hendrerit blandit. Aliquam viverra mi velit, non tincidunt nunc iaculis vel. Maecenas lobortis velit vel quam vehicula tincidunt. In rutrum bibendum porta. Donec mollis erat laoreet eros molestie dignissim. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Donec aliquam faucibus elementum. In ornare semper tellus, id laoreet diam. Proin ante tortor, lobortis eget ultricies vitae, porta non erat. Duis nec malesuada purus.
				...
				<div className="col-4 mb-0">
					<div style={{height:height-100+'px',maxHeight:'750px',overflow:'hidden'}}>
